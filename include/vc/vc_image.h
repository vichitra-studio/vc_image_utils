...
class vc_image {
  public:
    ...
    //      a later cast would help) -> std::make_shared<vc::pixel_buffer>(count, 0.0f)
    ...
    // TODO(you): total number of pixel_value elements in the buffer
    // (width * height * channels). Mind overflow — see Sec 6.3.
